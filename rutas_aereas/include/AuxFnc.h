 ...
 * 
 * @param p1, p2 Los dos puntos de los que queremos averiguar el angulo de inclinacion que tienen
 ...
 * @param directorioBanderas Ruta relativa donde se encuentra el directorio de banderas
 * @param mapa Mapa en el que pintaremos los aviones y las banderas. Seleccionado al principio 
*/
