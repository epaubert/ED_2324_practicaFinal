...
public:
   ...
   * @param rutaPaises Objeto donde guardaremos los resultados de la busqueda
   * dentro de P
   */
   ...
   *
   * Iterador creado para poder iterar sobre la estructura **list<Punto>
   * puntos** dentro de Ruta
   */
  class iterator {
  private:
   ...
   *
   * @return Un iterador apuntando al principio de la estructura **list<Punto>
   * puntos**
   */
  iterator begin();
   ...
   *
   * @return Un iterador apuntando al final de la estructura **list<Punto>
   * puntos**
   */
  iterator end();
   ...
   * @return Un iterador apuntado al Punto encontrado (si no es encontrado
   * apuntara al final)
   */
