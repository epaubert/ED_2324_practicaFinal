...
/**
 * @brief Almacén de rutas identificadas por un código.
 */
class Almacen_Rutas {
private:
...
public:
   ...
   *
   * Iterador creado para poder iterar sobre la estructura **map<std::string,
   * Ruta> rutas** dentro de Almacen_Rutas
   */
  class iterator {
  private:
   ...
   *
   * @return Un iterador apuntando al principio de la estructura
   * **map<std::string, Ruta> rutas**
   */
  iterator begin();
   ...
   *
   * @return Un iterador constante apuntando al principio de la estructura
   * **map<std::string, Ruta> rutas**
   */
   ...
   *
   * @return Un iterador apuntando al final de la estructura **map<std::string,
   * Ruta> rutas**
   */
  iterator end();
   ...
   *
   * @return Un iterador constante apuntando al final de la estructura
   * **map<std::string, Ruta> rutas**
   */
   ...
   *
   * Muestra todas las rutas disponibles dentro de la estructura
   * **map<std::string, Ruta> rutas**
   *
   ...
   *
   * @param P Lista de Paises existentes para poder dar nombre y banderas a los
