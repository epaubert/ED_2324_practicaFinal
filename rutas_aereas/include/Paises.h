...
public:
  ...
  */
   ...
   * 
   * Iterador creado para poder iterar sobre la estructura **set<Pais> datos** dentro de Paises
  */
  class iterator {
  private:
    set<Pais>::iterator p;
  ...
  */
   ...
   * 
   * @return Un iterador apuntando al principio de la estructura **set<Pais> datos**
  */
  ...
  */
   ...
   * @return Un iterador apuntando al Pais encontrado (Sino lo encuentra apuntara al final)
  */
   ...
   * @return Un iterador apuntando al Punto encontrado (Sino lo encuentra apuntara al final)
  */
   ...
   * 
   * Sobrecarga que permite la escritura de datos dentro de la estructura **set<Pais> datos**
   * 
  ...
  */
   ...
   * @brief Sobrecarga del **operator<<**
   * 
   * Sobrecarga que permite la salida de datos dentro de la estructura **set<Pais> datos**
   * 
